...
location_pipe1 = Pipeline(steps=[
    ("grouper", RareLabelEncoder(tol=0.1, replace_with="Other", n_categories=2)),
    ("encoder", MeanEncoder(variables=["source", "destination"])), #made changes here
...
path = r"D:\Data Science\Machine Learning\Flight Price Prediction using AWS Sagemaker\Datasets\train.csv"
train = pd.read_csv(path)
X_train = train.drop(columns="price")
y_train = train.price.copy()

#Fit and save the preprocessor
preprocessor.fit(X_train, y_train) #made changes here
...
st.title("Flight Prices Prediction Using AWS-Sagemaker")
#User Inputs:
